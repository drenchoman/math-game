...
let hstreaks = localStorage.getItem("highStreaks");
let highScores = hs ? JSON.parse(localStorage["highScores"]) : [];
let highStreaks = hstreaks ? JSON.parse(localStorage["highStreaks"]) : [];
let difficulty = 0;
let subHighScore = 0;
let subHighStreak = 0;
